...
import ArticleInfoForm from '@/app/[lang]/owner/properties/add/article-info-form';
import BasicInfoForm from '@/app/[lang]/owner/properties/add/basic-info-form';
import ImagesForm from '@/app/[lang]/owner/properties/add/images-form';
import PropertyInfoForm from '@/app/[lang]/owner/properties/add/property-info-form';
...
const AddPropertyForm = ({ addPropertyDict, lang }: { addPropertyDict: AddPropertyDictionary; lang: string }) => {
    ...
    const basicInfoItems: CollapseProps['items'] = [
        {
            key: '1',
            label: addPropertyDict['basic-info'],
            children: <BasicInfoForm form={form} addPropertyDict={addPropertyDict} setAddressName={setAddressName} />,
        },
    ];
    const articleInfoItems: CollapseProps['items'] = [
        {
            key: '1',
            label: addPropertyDict['article-info'],
            children: <ArticleInfoForm addPropertyDict={addPropertyDict} />,
        },
    ];
    const propertyInfoItems: CollapseProps['items'] = [
        {
            key: '1',
            label: addPropertyDict['property-info'],
            children: <PropertyInfoForm addPropertyDict={addPropertyDict} />,
        },
    ];
    const imagesItems: CollapseProps['items'] = [
        {
            key: '1',
            label: addPropertyDict['image-video'],
            children: <ImagesForm addPropertyDict={addPropertyDict} />,
        },
    ];
    ...
    const handleFinish = async (values: IPropertyForm) => {
        ...
        try {
            ...
            router.push(`/${lang}${OWNER_PROPERTIES}`);
        } catch (error) {
            console.error(error);
        } finally {
            setLoading(false);
